...
```
장비 19계열 · 공통 포인트 236 · 모델 63건 · 모델 포인트 10,510점
정격 사양: 모델 45건 · 형번 35개 · 제품 사진 모델 36 + 형번 35
검증: 오류 0 · 경고 73 · 정보 146
...
계열별 사양 확보: 냉동기 24/26 · 공조기 6/6 · 송풍기 3/4 · VAV 3/4 ·
전력 2/2 · 계량·제어 4/14 · VRF 1/3 · 인버터 1/3 · 펌프 1/1
...
에너지밸브·EPIV 처럼 형번 조합이 많은 제품은 **계열 문서에만** 있다.
```
